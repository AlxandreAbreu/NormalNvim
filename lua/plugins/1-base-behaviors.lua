...
--       -> todo-comments.nvim     [TODOs eye candy]
...
return {
  ...
  -- NOTE: todo-comments.nvim [TODOs eye candy]
  -- https://github.com/folke/todo-comments.nvim
  -- TODO: https://github.com/folke/todo-comments.nvim#jumping
  -- TODO: https://github.com/folke/todo-comments.nvim#-usage
  -- TODO: search todos with telescope
  {
    ...
    -- stylua: ignore
    keys = {
      -- TODO: change TODO-comments keybindings
      { "]t", function() require("todo-comments").jump_next() end, desc = "Next Todo Comment" },
      { "[t", function() require("todo-comments").jump_prev() end, desc = "Previous Todo Comment" },
      { "<leader>Dt", "<cmd>Trouble todo toggle<cr>", desc = "Todo (Trouble)" },
      { "<leader>Df", "<cmd>Trouble todo toggle filter = {tag = {TODO,FIX,FIXME}}<cr>", desc = "Todo/Fix/Fixme (Trouble)" },
      { "<leader>ft", "<cmd>TodoTelescope<cr>", desc = "Search TODOs" },
      { "<leader>fT", "<cmd>TodoTelescope keywords=TODO,FIX,FIXME<cr>", desc = "Search Todo/Fix/Fixme" },
    },
  },
